...
class Config:
    def __init__(self,
                 ...
                 xsecPath = "data/lastcrossTest_Toydata.npy",
                 parPath = "data/lastparTrue_Toydata.npy",
                 #--- scalers path
                 xsecScalerPath = 'scalers/AEmdnCrossScaler.sav',
                 pcaScalerPath = 'scalers/pcaAEmdnCrossScaler.sav',
                 outScalerPath = 'scalers/AEmdnParScaler.sav',
                 #--- Plot titles
        ...
        self.__xsecPath = xsecPath
        self.__parPath = parPath
        #--- paths of data scalars
        self.__xsecScalerPath = xsecScalerPath
        self.__pcaScalerPath = pcaScalerPath
        self.__outScalerPath = outScalerPath
        #--- Plot titles
    ...
    @property
    def xsecScalerPath(self):
        return self.__xsecScalerPath
    
    @property
    def pcaScalerPath(self):
        return self.__pcaScalerPath
    
    @property
    def outScalerPath(self):
        return self.__outScalerPath
